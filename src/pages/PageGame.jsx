...
export default class PageGame extends React.Component {
  ...
  render() {
    return (
      <Page
        onMounted={(css, canvasOwnerElement) => {
          this.playground.appendWebGLElementTo(canvasOwnerElement, css['page'])
          this.playground.appendLabelElementTo(canvasOwnerElement, css['page_app'])
          document.addEventListener('click', (event) => {
            if (event.target !== canvasOwnerElement.querySelector(`.${css['page']}`)) {
              return
            }
